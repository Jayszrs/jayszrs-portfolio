...
const DICTIONARY = {
  en: {
    ...
    "Kasih masukan": "Leave feedback",
    "Kritik dan saran yang kamu kirim langsung ditampilkan.": "Your feedback and suggestions are shown right away.",
    "Mengirim...": "Sending...",
    "Kirim masukan": "Send feedback",
    "Rating terkirim. Refresh halaman jika belum langsung terlihat.": "Feedback sent. Refresh the page if it does not appear right away.",
  ...
  fr: {
    ...
    "Kasih masukan": "Donner un avis",
    "Kritik dan saran yang kamu kirim langsung ditampilkan.": "Vos retours et suggestions sont affiches directement.",
    "Mengirim...": "Envoi...",
    "Kirim masukan": "Envoyer l'avis",
    "Rating terkirim. Refresh halaman jika belum langsung terlihat.": "Avis envoye. Actualisez la page s'il n'apparait pas tout de suite.",
